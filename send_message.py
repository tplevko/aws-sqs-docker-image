...
def get_sqs_client(aws_access_key_id, aws_secret_access_key, region_name):
...
if __name__ == '__main__':
    ...
    send(aws_access_key_id, aws_secret_access_key,
         region_name, queue, account_id, aws_sqs_text)
